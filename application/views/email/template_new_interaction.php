                                    ...
                                    <table bgcolor="#FFFFFF" border="0" cellpadding="20" cellspacing="0" width="100%" id="content">
                                        <tr>
                                            <td width="25%" align='left' valign='top'>
                                                <img id="posterImg" src="<?=$posterImgUrl?>" width="120" />
                                            </td>
                                            <td id="interaction" align='left' valign='top'>
                                                <b style="color: #868974;">Hi <?=$receiverFname?>,</b>
                                                <p style="color: #868974;">
                                                    <b style="color:#f38630;font-weight:normal;"><?=$posterFname?>&nbsp;<?=$posterLname?></b> just logged a new interaction with <b><?=$familyName?></b>:
                                                </p>
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="description">
                                                    <tr>
                                                        ...
                                                        <td align='left' valign='top'>
                                                            <b style="color: #868974;"><?=$description?></b>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height='20'></td>
